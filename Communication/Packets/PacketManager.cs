...
using Neon.Communication.Packets.Incoming.Avatar;
using Neon.Communication.Packets.Incoming.Calendar;
using Neon.Communication.Packets.Incoming.Catalog;
using Neon.Communication.Packets.Incoming.GameCenter;
using Neon.Communication.Packets.Incoming.Groups;
using Neon.Communication.Packets.Incoming.Groups.Forums;
using Neon.Communication.Packets.Incoming.Handshake;
using Neon.Communication.Packets.Incoming.Help;
using Neon.Communication.Packets.Incoming.Help.Helpers;
using Neon.Communication.Packets.Incoming.Inventory.Achievements;
using Neon.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Neon.Communication.Packets.Incoming.Inventory.Badges;
using Neon.Communication.Packets.Incoming.Inventory.Bots;
using Neon.Communication.Packets.Incoming.Inventory.Furni;
using Neon.Communication.Packets.Incoming.Inventory.Pets;
using Neon.Communication.Packets.Incoming.Inventory.Purse;
using Neon.Communication.Packets.Incoming.Inventory.Trading;
using Neon.Communication.Packets.Incoming.LandingView;
using Neon.Communication.Packets.Incoming.Marketplace;
using Neon.Communication.Packets.Incoming.Messenger;
using Neon.Communication.Packets.Incoming.Misc;
using Neon.Communication.Packets.Incoming.Moderation;
using Neon.Communication.Packets.Incoming.Navigator;
using Neon.Communication.Packets.Incoming.Nucs;
using Neon.Communication.Packets.Incoming.Quests;
using Neon.Communication.Packets.Incoming.QuickPolls;
using Neon.Communication.Packets.Incoming.Rooms.Action;
using Neon.Communication.Packets.Incoming.Rooms.AI.Bots;
using Neon.Communication.Packets.Incoming.Rooms.AI.Pets;
using Neon.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Neon.Communication.Packets.Incoming.Rooms.Avatar;
using Neon.Communication.Packets.Incoming.Rooms.Camera;
using Neon.Communication.Packets.Incoming.Rooms.Chat;
using Neon.Communication.Packets.Incoming.Rooms.Connection;
using Neon.Communication.Packets.Incoming.Rooms.Engine;
using Neon.Communication.Packets.Incoming.Rooms.FloorPlan;
using Neon.Communication.Packets.Incoming.Rooms.Furni;
using Neon.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Neon.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Neon.Communication.Packets.Incoming.Rooms.Furni.RentableSpaces;
using Neon.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Neon.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Neon.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Neon.Communication.Packets.Incoming.Rooms.Music;
using Neon.Communication.Packets.Incoming.Rooms.Polls;
using Neon.Communication.Packets.Incoming.Rooms.Settings;
using Neon.Communication.Packets.Incoming.Sound;
using Neon.Communication.Packets.Incoming.Talents;
using Neon.Communication.Packets.Incoming.Users;
...
namespace Neon.Communication.Packets
{
    ...
    {
        private static readonly ILog log = LogManager.GetLogger("Neon.Communication.Packets");
        ...
        public PacketManager()
        {
            ...
            //this.RegisterNames();
            RegisterRoomCamera();
            RegistrarNucsEventos(); // engespañol
        }
        ...
        private void RegisterLandingView()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.ConcurrentUsersCompetitionEvent, new ConcurrentUsersCompetition());
        ...
        private void RegisterRoomCamera()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.BuyServerCameraPhoto, new BuyServerCameraPhoto());
        ...
        private void RegisterTalents()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.GetCitizenshipTypeEvent, new GetCitizenshipTypeEvent());
        ...
        private void RegisterSound()
        {
            ...
            _incomingPackets.Add(ClientPacketHeader.AddPlaylistItemMessageEvent, new AddPlaylistItemEvent());
            _incomingPackets.Add(ClientPacketHeader.GetJukeboxDisksMessageEvent, new GetJukeboxDisksEvent());
            _incomingPackets.Add(ClientPacketHeader.GetJukeboxPlaylistsMessageEvent, new GetJukeboxPlaylistsEvent());
            _incomingPackets.Add(ClientPacketHeader.GetMusicDataMessageEvent, new GetMusicDataEvent());
            _incomingPackets.Add(ClientPacketHeader.RemovePlaylistItemMessageEvent, new RemovePlaylistItemEvent());
            _incomingPackets.Add(ClientPacketHeader.SyncMusicMessageEvent, new SyncMusicEvent());
        }
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.GetHCCatalogGiftsEvent, new GetHCCatalogGiftsEvent());
