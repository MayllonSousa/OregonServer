    ...
    public class Pet
    {
        ...
        public void Addexperience(int Amount)
        {
            ...
            if (Room != null)
            {
                ...
                {
                    if (NeonEnvironment.GetGame().GetClientManager().GetClientByUserID(OwnerId) != null)
                    {
                        NeonEnvironment.GetGame().GetAchievementManager().ProgressAchievement(NeonEnvironment.GetGame().GetClientManager().GetClientByUserID(OwnerId), "ACH_PetLevelUp", 1);
                    }
