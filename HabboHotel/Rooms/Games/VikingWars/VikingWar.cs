...
//namespace Neon.HabboHotel.Rooms.Games.VikingWars
//{
...
//            timestarted = NeonEnvironment.GetUnixTimestamp();
...
//                        {
//                            NeonEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallTilesLocked", User.LockedTilesCount);
//                            NeonEnvironment.GetGame().GetAchievementManager().ProgressAchievement(User.GetClient(), "ACH_BattleBallPlayer", 1);
//                        }
//                    }
